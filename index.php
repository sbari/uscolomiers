...
<div class="fh5co-hero">
    ...
    <div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/althéro/2.png);">
        <div class="desc animate-box">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h2>Musculation, Haltérophilie &amp; Force athlétique
                            <p><span> US Colomiers au complexe capitany à Colomiers</span></p>
                            <span><a class="btn btn-primary" href="#">Nous contacter</a></span>
                    </div>
                </div>
            </div>
        </div>
...
<div id="fh5co-schedule-section" class="fh5co-lightgray-section">
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="heading-section text-center ">
                    <h2>Planning</h2>
                    <p>En plus des activités principales, nos coachs font des cours d'abdos/fessiers ainsi que du strech.</p>
                </div>
            </div>
        </div>
        <div class="row animate-box">
            <div class="col-md-10 col-md-offset-1 text-center">
                <ul class="schedule">
                    <li><a href="#" class="active" data-sched="monday">Lundi</a></li>
                    ...
                    <li><a href="#" data-sched="monday">Vendredi</a></li>
                    ...
                    <div class="schedule-content active" data-day="monday">
                        <div class="col-md-3 col-sm-6">
                            <div class="program program-schedule">
                                ...
                                <small>10h30-13h / 15h30-21h</small>
                                <h3>Musculation</h3>
                                <span>Eric & Julien</span>
                            </div>
                        </div>
                    </div>
                    <!-- END sched-content -->
    ...
    <div class="fh5co-parallax" style="background-image: url(images/althéro/3.png);" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
                    <div class="fh5co-intro fh5co-table-cell animate-box">
                        <h1 class="text-center">+ qu'un sport, une passion</h1>
                        <p>Nous sommes une association, nos prix sont donc plus abordables</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="heading-section text-center animate-box">
                        <h2>Nos COACHS</h2>
                        <p>Deux coachs à pleins temps et des coachs bénévoles</p>
                    </div>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-4 col-sm-6">
                    <div class="team-section-grid animate-box" style="background-image: url(images/coachs/eric.png);">
                        <div class="overlay-section">
                            <div class="desc">
                                <h3>Eric Nisseron</h3>
                                <span>Coach Professionnel</span>
                                <p>Eric vous coachera pour les activités de musculation et d'althérophilie</p>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="team-section-grid animate-box" style="background-image: url(images/coachs/julien.jpg);">
                        <div class="overlay-section">
                            <div class="desc">
                                <h3>Julien Devaux</h3>
                                <span>Coach Professionnel</span>
                                <p>Julien vous coachera pour les activités de musculation et de force athlétique</p>
                                <p class="fh5co-social-icons">
                                    <a href="#"><i class="icon-twitter-with-circle"></i></a>
                                    <a href="#"><i class="icon-facebook-with-circle"></i></a>
                                    <a href="#"><i class="icon-instagram-with-circle"></i></a>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="team-section-grid animate-box" style="background-image: url(images/coachs/bastien.jpg);">
                        <div class="overlay-section">
                            <div class="desc">
                                <h3>Bastien MARRAGOU</h3>
                                <span>Coach Bénévole</span>
                                <p>Bastien vous coachera dans vos activités</p>
                                <p class="fh5co-social-icons">
                                    <a href="#"><i class="icon-twitter-with-circle"></i></a>
                                    <a href="#"><i class="icon-facebook-with-circle"></i></a>
                                    <a href="#"><i class="icon-instagram-with-circle"></i></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="heading-section text-center animate-box">
                        <h2>Tarifs</h2>
                        <p>Ci-dessous nos tarifs pour la saison 2016/2017.</p>
                    </div>
                </div>
                <div class="row animate-box">
                <div class="col-md-10 col-md-offset-1 text-center">
                    <ul class="schedule">
                        <li><a href="#" class="active" data-sched="columerins">Columérins</a></li>
                    ...
                    <div class="row text-center">
                        <div class="col-md-12 schedule-container"> 
                            <div class="schedule-content active" data-day="columerins">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="program program-schedule">
                                        <div class="price">175 <sup class="currency">€</sup><small>/an</small></div>
                                        <small>Licence individuelle</small>
                                        <h3>INDIVIDUEL</h3>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6">
                            ...
                            <div class="schedule-content" data-day="exterieur">
                                <div class="col-md-3 col-sm-6">
                                    <div class="program program-schedule">
                                        <img src="images/fit-dumbell.svg" alt="Cycling">
                                        <small>10h30-13h / 15h30-21h</small>
